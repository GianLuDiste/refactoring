...
//Query escrita sin ALIAS resumidos (al profe le gusta más):
...
function getStudentSubjectByIds($conn, $studentId, $subjectId)
{
    ...
    return $result->fetch_assoc(); // null si no existe
}
